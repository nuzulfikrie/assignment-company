        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    ...
                    />
                    <TeamMember
                        imgSrc="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png"
                        name="Michael Gough"
...
const TeamMember: React.FC<TeamMemberProps> = ({ imgSrc, name, title, description }) => {
    return (
        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={imgSrc} alt={`${name} Avatar`} />
            </a>
            <div className="p-5">
